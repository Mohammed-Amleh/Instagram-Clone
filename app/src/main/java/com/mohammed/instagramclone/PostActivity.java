...
//        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(com.mohammed.instagramclone.PostActivity.this, MainActivity.class));
                finish();
            }
        });
        ...
        CropImage.activity().start(com.mohammed.instagramclone.PostActivity.this);
    }
        ...
        if (imageUri != null) {
            ...
            uploadtask.continueWithTask(new Continuation() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(com.mohammed.instagramclone.PostActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        } else {
